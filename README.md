...
The **Latin Diachronic Database** is a project of Digital Humanities invented by **Dr Tommaso Spinelli** (Classics, St. Andrews University) and co-developed with **Giacomo Fenzi** (Computer Science and Mathematics student, St. Andrews University) and the assistance of **Dr William Short**. This project aims to create an innovative toolkit for the quantitative computational analysis of the Latin language as well as to support and further enhance the digital study of ancient intertextuality.
